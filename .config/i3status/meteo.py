...
APPID = "1f07fb43029e9159ffd94a005104fdff"
...
with urllib.request.urlopen("https://api.openweathermap.org/data/2.5/weather?id=" + CITYID + "&units=metric&appid=" + APPID) as url:
    ...
    if int(data['weather'][0]['id']) >= 200 and int(data['weather'][0]['id']) < 300:
    ...
    elif int(data['weather'][0]['id']) >= 700 and int(data['weather'][0]['id']) < 800:
        str += ""
